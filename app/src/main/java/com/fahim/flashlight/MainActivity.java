...
import static com.fahim.flashlight.R.*;

public class MainActivity extends AppCompatActivity implements Camera.AutoFocusCallback {
    public static final String START_APP_ID;

    static {
        START_APP_ID = "201729595";
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //Todo 2/3/2021 (int StartApk SDK)
        ...
        if (savedInstanceState != null) {
            ...
            if (defaultOption == 2) {
                Log.d("flashy", "saved 2, " + savedInstanceState.getInt("brightness"));
...
//        defaultOption = prefs.getInt("default_option", 1);// 1 means flash light is selected
    ...
    void refreshActivityForFlashLight() {
        ...
        if (!hasFlash) {
            ...
            RelativeLayout useScreen = FlashDialog.findViewById(id.container_use_screen);
...
//            seekBar.setPointerColor(Color.parseColor("#FFB137"));
    ...
    void findViews() {
        seekBar = findViewById(id.progress_circular);
        bg_options = findViewById(id.bg_options);
        bg_option_circle = findViewById(id.bg_option_circle);
        iconFlash = findViewById(id.flash_icon);
        iconScreen = findViewById(id.screen_icon);
        powerCenter = findViewById(id.power_center);
        powerIconCenter = findViewById(id.power_icon_center);
        powerIconCenterStand = findViewById(id.power_icon_center_stand);
    }
